...
"Hatin" меняется во времени и лице; спрягается с объектом. Субъект в прошедших временах тоже имеет исходный падеж, так как является и субъектом и объектом действия.
